...
//TODO: insert k in the equations

class SpringsSystem{
    double m, k, alpha, beta;
    public:
        SpringsSystem(const double& m_in, const double& k_in, const double& alpha_in, const double& beta_in):m(m_in), k(k_in), alpha(alpha_in), beta(beta_in) {}
